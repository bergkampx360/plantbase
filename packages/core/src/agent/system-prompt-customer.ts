// Az ügyfél-facing agent system promptja (J3, HF5, docs/implementation/09-customer-facing-poc.md)
// — docs/system-prompt-customer.md tartalmával szinkronban tartandó. A belső system-prompt.ts-től
// eltérően NEM SQL-generálásra tanítja a modellt (nincs runSql tool), hanem whitelistelt
// searchProducts-szűrőkre, és explicit eszkalációs szabályt ad (requestHumanHandoff).
export const SYSTEM_PROMPT_CUSTOMER = `<role>
