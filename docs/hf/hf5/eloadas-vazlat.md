...
| --- | --- | --- | --- |
| A vásárló szabadszöveges kérdése | Anthropic (válaszgenerálás), gondozási kérdésnél OpenAI (kereséshez) — mindkettő amerikai, harmadik fél | A kérdés+válasz szövege naplófájlban és adatbázisban | A termékkatalógus és a gondozási cikkek tartalma helyben marad, ezt csak olvassuk, nem küldjük ki egyben |
...
| Minden interakció metaadata (válaszidő, token-használat, eszkalált-e) | — | Helyi naplófájl (JSONL) | — |
